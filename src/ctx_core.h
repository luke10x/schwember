...
/* *********************************************************************
 * Private functions used in the constructor, but defined after
 * ********************************************************************/
inline static void
ctx_resize_framebuffer_to_window(ctx_t *c, int *width, int *height);
...
/* *********************************************************************
 * Resize framebuffer to window
 * ********************************************************************/
inline static void
ctx_resize_framebuffer_to_window(ctx_t *ctx, int *width, int *height)
{
...
/* *********************************************************************
 * Private functions used from the next function but declared after
 * ********************************************************************/
...
void ctx_perform_one_cycle(ctx_t *ctx)
{
    ...
    double time_since_fps_print = current_time - last_fps_print_time;

    if (time_since_fps_print >= 5.0) {
        // Calculate the FPS and print it to the console
        double fps = frames_rendered / time_since_fps_print;
